...
const styles = StyleSheet.create({
  ...
  faturasPanel: {
    ...
    marginTop: 16,
    ...shadow('0 18px 34px rgba(0,0,0,0.10)', {
      color: '#000',
  ...
  // ── NOVO DESIGN: lista de faturas (cards) ────────────────────────────────
  faturasTitle: {
    color: '#111827',
    fontSize: 44,
    fontWeight: '900',
  ...
  /** Botão "Voltar" no canto superior esquerdo (telas de fluxo). */
  backCornerButton: {
    position: 'absolute',
    top: 18,
    left: 18,
    ...
    alignItems: 'center',
    gap: 10,
    ...shadow('0 10px 18px rgba(0,0,0,0.10)', {
      color: '#000',
      offset: { width: 0, height: 6 },
      opacity: 0.12,
      radius: 10,
